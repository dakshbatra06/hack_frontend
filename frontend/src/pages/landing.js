      ...
      <Box bg="white" px={6} py={16}>
        ...
        >
          <VStack align="start" spacing={6} flex="1">
            ...
            <Heading fontSize={{ base: '3xl', md: '5xl' }} fontWeight="extrabold" color="gray.900">
              Turn your{' '}
            ...
            <Text fontSize="lg" color="gray.600" maxW="lg">
              An AI-powered agent that transforms your internal activities into high-quality, personalized, and clear content. You build. We write.
            </Text>
            <HStack spacing={4}>
              <Button colorScheme="purple" size="lg">
                Get Started
              </Button>
              <Button variant="outline" size="lg" onClick={() => navigate('/showcase')}>
                Learn More
              </Button>
            </HStack>
          </VStack>
        ...
        <Box textAlign="center" px={4} pt={4} pb={20}>
          ...
          <Text fontSize="md" color="gray.600" mb={12}>
            Unlike traditional AI content tools, QuickComs is specifically designed for startup founders and their internal communication needs.
          </Text>
